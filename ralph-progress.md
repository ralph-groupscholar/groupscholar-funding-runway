...
- 2026-02-08: Added inflow/outflow concentration analytics (HHI + top-share) to console/JSON, extended DB schema for concentration fields, and seeded production with a fresh snapshot.
